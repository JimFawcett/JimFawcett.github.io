...
function initializePages() {
  ...
  if (isDefined(pagesMenu)) {
    ...
    pagesMenu.innerHTML = "<div class='darkItem popupHeader' onclick='bottomMenu.pages()'>&nbsp;WebDev&nbsp;Track&nbsp;</div>\
          <menu-elem class='ddItems pageElem'><a target='_parent' href='indexDesign'>Track&nbsp;Summary&nbsp;</a></menu-elem>\
          <menu-elem class='ddItems pageElem'><a target='_parent' href='DesignBites.html'>Track&nbsp;Repo</a>&nbsp;</menu-elem>\
