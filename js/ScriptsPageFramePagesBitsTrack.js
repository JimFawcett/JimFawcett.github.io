...
function initializePages() {
  ...
  if (isDefined(pagesMenu)) {
    ...
    pagesMenu.innerHTML = "<div class='darkItem popupHeader' onclick='bottomMenu.pages()'>C++ Thread</div>\
          ...
          <menu-elem class='ddItems pageElem'><a href='Resources/CppBites/CppBites_Intro.html'>Intro</a></menu-elem>\
          <menu-elem class='ddItems pageElem'><a href='Resources/CppBites/CppBites_Survey.html'>Survey</a></menu-elem>\
          <menu-elem class='ddItems pageElem'><a href='Resources/CppBites/CppBites_STR.html'>STR</a></menu-elem>\
